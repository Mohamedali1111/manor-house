...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 sm:py-20 lg:py-24 xl:py-32 px-4 sm:px-6 bg-gradient-to-b from-card via-muted to-background relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-foreground mb-4 sm:mb-6 hover-text-enhance">
              Our <span className="gradient-text-gold">Services</span>
            </h2>
            <p className="text-base sm:text-lg lg:text-xl text-foreground/70 max-w-3xl mx-auto leading-relaxed hover-text-enhance">
      ...
      <section className="py-16 sm:py-20 lg:py-24 xl:py-32 px-4 sm:px-6 bg-background relative">
      ...
      <section className="py-16 sm:py-20 lg:py-24 xl:py-32 px-4 sm:px-6 relative overflow-hidden">
        {/* Enhanced Background Elements */}
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          {/* Premium Badge */}
          <div className="inline-flex items-center px-4 sm:px-6 py-1.5 sm:py-2 bg-accent/10 border border-accent/20 rounded-full mb-6 sm:mb-8 premium-badge">
            <span className="text-accent text-xs sm:text-sm font-semibold hover-text-enhance">Get Started</span>
          </div>
          
          <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-foreground mb-6 sm:mb-8 hover-text-enhance">
            Ready to Transform Your <span className="gradient-text-gold">Space</span>?
          </h2>
          <p className="text-base sm:text-lg lg:text-xl xl:text-2xl text-foreground/80 mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed hover-text-enhance">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-8 sm:mb-10">
            ...
            >
              Start Your Project
              <span className="group-hover:translate-x-1 transition-transform duration-300 text-lg sm:text-xl xl:text-2xl">→</span>
            </PremiumButton>
            <PremiumButton
          ...
          <div className="mt-8 sm:mt-10 p-4 sm:p-6 glass-premium rounded-xl sm:rounded-2xl border border-accent/20">
            <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 text-sm sm:text-base text-foreground/70">
